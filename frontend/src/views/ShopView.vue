<template>
  <div class="flex background flex-col items-center">
    <div class="flex gap-4 my-4">
      <button
        class="inline-flex h-12 text-white items-center justify-center rounded-md bg-gradient-to-t from-purple-500 to-blue-500 px-6 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
        @click="generateProduct">
        Generate Product
      </button>
      <button
        class="bg-blue-600 text-white px-4 py-2 rounded-md transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-50"
        @click="ViewApi">
        See API
      </button>
      <button
        class="bg-red-600 text-white px-4 py-2 rounded-md transition-colors hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-slate-50"
